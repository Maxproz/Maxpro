...
#include "MaxproCharacter.generated.h"

class UTextRenderComponent;

/**
 * This class is the default character for Maxpro, and it is responsible for all
 ...
 */
UCLASS(config=Game)
class AMaxproCharacter : public APaperCharacter
{
	GENERATED_BODY()
